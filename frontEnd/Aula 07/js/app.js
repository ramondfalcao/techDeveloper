...
//Cria um elemento para atribuição de um pai 
let son = document.createElement("nav")

//Criar um elemento de texto, um nó para atribuição de um pai
let grandson = document.createTextNode("Barra de ferramentas")

//Atribui um pai ao elemento 
son.appendChild(grandson)

//Atribui o elemento ao HTML
document.body.appendChild(son)

let guepardo = document.querySelector("#guepardo")

if (guepardo.hasAttribute("alt")) {
    console.log("Tem uma descrição")
} else {
    guepardo.setAttribute("alt", "Um felino amarelo com pinta pretas.")
}

console.log(guepardo.getAttribute("src"))

guepardo.removeAttribute("src")
